            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Añadir administrador</h1>
                    </div>
                    ...
                    <div class="border border-black rounded mx-auto p-4" style="width: 70%;">
                        ...
                        <form name="fNewAdmin" id="fNewAdmin" action="newAdmin" method="POST">

                            <div class="row">
                                <h2 class="h3 px-3 text-gray-800">Datos de alta</h2>
                            </div>
                            <hr class="mt-0 mb-3">
                            ...
                            <div class="form-group row">
                                <label for="rpwd" class="col-sm-2 col-form-label">Repita contraseña</label>
                                <div class="col-sm-10">
