            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="border border-black rounded mx-auto p-4" style="width: 70%;">
                        ...
                        <form name="fchangePassword" id="fchangePassword" action="changePassword" method="POST">

                            <div class="row">
                                <h2 class="h3 px-3 text-gray-800">Datos contraseña actual </h2>
                            </div>
                            <hr class="mt-0 mb-3">
                            ...
                            <div class="row">
                                <h2 class="h3 px-3 text-gray-800">Datos nueva contraseña</h2>
                            </div>
                            <hr class="mt-0 mb-3">


                            <div class="form-group row">
                                <label for="npwd" class="col-sm-2 col-form-label">Nueva contraseña</label>
                                <div class="col-sm-10">
                            ...
                            <div class="form-group row">
                                <label for="rpwd" class="col-sm-2 col-form-label">Repita nueva contraseña</label>
                                <div class="col-sm-10">
