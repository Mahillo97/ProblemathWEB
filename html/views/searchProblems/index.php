            ...
            <div class="col-sm-6 text-left">
                ...
                <div class="list-group">
                    <a href="/ProblemFile?idProblem=1" class="list-group-item list-group-item-action flex-column align-items-start">
                        ...
                        <small>Gaceta Matematica </small>
                        <small>Oscar Ciaurri </small>
                    ...
                    <a href="/ProblemFile?idProblem=1" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Problema 2</h5>
                        </div>
                        <p class="mb-1">Consideremos la siguiente desigualdad .... Esto debe de estar en LaTeX</p>
                        <small>Manuel Bello</small>
                    </a>

                    <a href="/ProblemFile?idProblem=1" class="list-group-item list-group-item-action flex-column align-items-start">
                        <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Problema 3</h5>
                        </div>
                        <p class="mb-1">Consideremos f(x) una función real .... Esto debe de estar en LaTeX</p>
                        <small>AMS</small><small>Oscar Ciaurri</small>
                    </a>
                </div>
            </div>
            <div class="col-sm-3 sidenav">
